...
namespace TrackerLibrary
{
    ...
    {
        // Order our list randomly of teams - done
        // Check if list is big enough - if not, add byes(empty team) - 2*2*2*2 - 2^4 - done
        // Create our first round of matchups - done
        // Create every round after that - 8 matchups - 4 matchups - 2 matchups - 1 matchup - done
